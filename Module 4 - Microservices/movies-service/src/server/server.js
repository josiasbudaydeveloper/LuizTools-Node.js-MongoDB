...
const morgan = require('morgan'); // morgan is to see the received requests on the console
const helmet = require('helmet'); // helmet is to increase security in the app
